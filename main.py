...
while True:
    ...
    # checking if command is equal to "search item"
        ...
        # ACTIVITY HERE
        # Please insert search item (select and with) sql command here. we have already added 3 quotations on each side to deal with sql injection, please enter your command in between
        sql = """"""
    ...
    # checking if command is equal to "sort list"
        ...
        if sortID == "1":
            ...
            # ACTIVITY HERE
            # Please insert order item (select and orderby) sql command here (this is for ID Ascending)
            sql_select_Query = ""
        ...
        if sortID == "2":
            ...
            # ACTIVITY HERE
            # Please insert order item (select, orderby and desc) sql command here (this is for ID Descending)
            sql_select_Query = ""
        ...
        if sortID == "3":
            ...
            # ACTIVITY HERE
            # Please insert order item (select and orderby) sql command here (this is for Name Ascending)
            sql_select_Query = ""
        ...
        if sortID == "4":
            ...
            # ACTIVITY HERE
            # Please insert order item (select, orderby and desc) sql command here (this is for Name Descending)
            sql_select_Query = ""
